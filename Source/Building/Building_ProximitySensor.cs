...
public class Building_ProximitySensor : Building, ISwitchable, ISensorSettingsProvider
{
    ...
    public bool HasWirelessUpgrade => wirelessComp != null && wirelessComp.Enabled;

    public bool HasAIUpgrade => brainComp != null && brainComp.Complete;
    ...
    public override void DrawExtraSelectionOverlays()
    {
        ...
        for (var i = 0; i < trackedPawns.Count; i++)
        {
            if (trackedPawns == null)
            {
                continue;
    ...
    {
        if (brainComp == null || !brainComp.Complete || p.RaceProps == null)
        {
            return true;
        }
