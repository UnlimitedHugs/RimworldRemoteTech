...
namespace RemoteTech {
	...
	public class ITab_ExplosivesBills : ITab_Bills {
		...
		protected override void FillTab() {
			...
			var settingsRect = new Rect(canvasRect.x, canvasRect.y, canvasRect.width, Padding * 2f + SettingsRowHeight * 3f + Spacing * 2f);
			...
			var infoRect = new Rect(rowRect.xMax - InfoBtnSize, rowRect.y + (rowRect.height - InfoBtnSize)/2f, InfoBtnSize, InfoBtnSize);
			...
			mouseoverBill = SelTable.billStack.DoListing(recipesRect, RecipeOptionsMaker, ref scrollPosition, ref viewHeight);
		}
