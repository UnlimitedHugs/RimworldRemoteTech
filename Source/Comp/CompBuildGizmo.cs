...
namespace RemoteExplosives {
	...
	/// Relies on RemoteExplosivesController to maintain a list of buildings for each thing def with this comp.
	/// </summary>
	/// <see cref="RemoteExplosivesController"/>
	/// <see cref="CompProperties_BuildGizmo"/>
	public class CompBuildGizmo : ThingComp {
		public override IEnumerable<Gizmo> CompGetGizmosExtra() {
			if (RemoteExplosivesController.Instance.MaterialToBuilding.TryGetValue(parent.def, out List<ThingDef> buildingDefs)) {
